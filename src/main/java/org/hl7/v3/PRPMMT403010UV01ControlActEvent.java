...
/**
 * <p>PRPM_MT403010UV01.ControlActEvent complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="PRPM_MT403010UV01.ControlActEvent">
 *   &lt;complexContent>
 ...
 *         &lt;element name="dataEnterer" type="{urn:hl7-org:v3}PRPM_MT403010UV01.DataEnterer" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="custodian" type="{urn:hl7-org:v3}PRPM_MT403010UV01.Custodian" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPM_MT403010UV01.ControlActEvent", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPMMT403010UV01ControlActEvent {
    ...
    protected List<PRPMMT403010UV01DataEnterer> dataEnterer;
    @XmlElement(nillable = true)
    protected List<PRPMMT403010UV01Custodian> custodian;
     ...
     * {@link PRPMMT403010UV01DataEnterer }
     * 
     * 
     */
    public List<PRPMMT403010UV01DataEnterer> getDataEnterer() {
        if (dataEnterer == null) {
            dataEnterer = new ArrayList<PRPMMT403010UV01DataEnterer>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPMMT403010UV01Custodian }
     * 
     * 
     */
    public List<PRPMMT403010UV01Custodian> getCustodian() {
        if (custodian == null) {
            custodian = new ArrayList<PRPMMT403010UV01Custodian>();
        }

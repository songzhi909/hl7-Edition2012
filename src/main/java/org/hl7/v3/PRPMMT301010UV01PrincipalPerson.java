...
/**
 * <p>PRPM_MT301010UV01.PrincipalPerson complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="PRPM_MT301010UV01.PrincipalPerson">
 *   &lt;complexContent>
 ...
 *         &lt;element name="administrativeGenderCode" type="{urn:hl7-org:v3}CD"/>
 ...
 *         &lt;element name="asAffiliate" type="{urn:hl7-org:v3}PRPM_MT301010UV01.Affiliate" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="birthplace" type="{urn:hl7-org:v3}PRPM_MT301010UV01.Birthplace" minOccurs="0"/>
 *         &lt;element name="languageCommunication" type="{urn:hl7-org:v3}PRPM_MT301010UV01.LanguageCommunication" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPM_MT301010UV01.PrincipalPerson", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPMMT301010UV01PrincipalPerson {
    ...
    protected List<PRPMMT301010UV01Affiliate> asAffiliate;
    @XmlElementRef(name = "birthplace", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<PRPMMT301010UV01Birthplace> birthplace;
    @XmlElement(nillable = true)
    protected List<PRPMMT301010UV01LanguageCommunication> languageCommunication;
     ...
     * {@link PRPMMT301010UV01Affiliate }
     * 
     * 
     */
    public List<PRPMMT301010UV01Affiliate> getAsAffiliate() {
        if (asAffiliate == null) {
            asAffiliate = new ArrayList<PRPMMT301010UV01Affiliate>();
        }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PRPMMT301010UV01Birthplace }{@code >}
     *     
     */
    public JAXBElement<PRPMMT301010UV01Birthplace> getBirthplace() {
        return birthplace;
    }
     ...
     *     
     */
    public void setBirthplace(JAXBElement<PRPMMT301010UV01Birthplace> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPMMT301010UV01LanguageCommunication }
     * 
     * 
     */
    public List<PRPMMT301010UV01LanguageCommunication> getLanguageCommunication() {
        if (languageCommunication == null) {
            languageCommunication = new ArrayList<PRPMMT301010UV01LanguageCommunication>();
        }

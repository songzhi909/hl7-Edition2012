...
/**
 * <p>PRPM_MT401010UV01.RoleActivation complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="PRPM_MT401010UV01.RoleActivation">
 *   &lt;complexContent>
 ...
 *         &lt;element name="subjectOf" type="{urn:hl7-org:v3}PRPM_MT401010UV01.Subject6" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPM_MT401010UV01.RoleActivation", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "text",
...
public class PRPMMT401010UV01RoleActivation {
    ...
    protected List<PRPMMT401010UV01Subject6> subjectOf;
     ...
     * {@link PRPMMT401010UV01Subject6 }
     * 
     * 
     */
    public List<PRPMMT401010UV01Subject6> getSubjectOf() {
        if (subjectOf == null) {
            subjectOf = new ArrayList<PRPMMT401010UV01Subject6>();
        }

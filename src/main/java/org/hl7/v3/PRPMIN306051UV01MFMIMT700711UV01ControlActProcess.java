...
/**
 * <p>PRPM_IN306051UV01.MFMI_MT700711UV01.ControlActProcess complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="PRPM_IN306051UV01.MFMI_MT700711UV01.ControlActProcess">
 *   &lt;complexContent>
 ...
 *         &lt;element name="subject" type="{urn:hl7-org:v3}PRPM_IN306051UV01.MFMI_MT700711UV01.Subject1" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="queryByParameterPayload" type="{urn:hl7-org:v3}PRPM_MT306810UV01.QueryByParameterPayload" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPM_IN306051UV01.MFMI_MT700711UV01.ControlActProcess", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPMIN306051UV01MFMIMT700711UV01ControlActProcess {
    ...
    @XmlElement(nillable = true)
    protected List<PRPMIN306051UV01MFMIMT700711UV01Subject1> subject;
    @XmlElement(nillable = true)
    ...
    protected JAXBElement<PRPMMT306810UV01QueryByParameterPayload> queryByParameterPayload;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPMIN306051UV01MFMIMT700711UV01Subject1 }
     * 
     * 
     */
    public List<PRPMIN306051UV01MFMIMT700711UV01Subject1> getSubject() {
        if (subject == null) {
            subject = new ArrayList<PRPMIN306051UV01MFMIMT700711UV01Subject1>();
        }
        return this.subject;
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PRPMMT306810UV01QueryByParameterPayload }{@code >}
     *     
     */
    public JAXBElement<PRPMMT306810UV01QueryByParameterPayload> getQueryByParameterPayload() {
     ...
     *     
     */
    public void setQueryByParameterPayload(JAXBElement<PRPMMT306810UV01QueryByParameterPayload> value) {

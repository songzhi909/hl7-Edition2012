...
/**
 * <p>PRPM_IN306050UV01.MCCI_MT000100UV01.Message complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="PRPM_IN306050UV01.MCCI_MT000100UV01.Message">
 *   &lt;complexContent>
 ...
 *         &lt;element name="controlActProcess" type="{urn:hl7-org:v3}PRPM_IN306050UV01.QUQI_MT021001UV01.ControlActProcess"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPM_IN306050UV01.MCCI_MT000100UV01.Message", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
@XmlSeeAlso({
    PRPMIN306050UV01 .class
})
public class PRPMIN306050UV01MCCIMT000100UV01Message {
    ...
    @XmlElement(required = true)
    protected PRPMIN306050UV01QUQIMT021001UV01ControlActProcess controlActProcess;
     ...
     * @return
     *     possible object is
     *     {@link PRPMIN306050UV01QUQIMT021001UV01ControlActProcess }
     *     
     */
    public PRPMIN306050UV01QUQIMT021001UV01ControlActProcess getControlActProcess() {
     ...
     *     
     */
    public void setControlActProcess(PRPMIN306050UV01QUQIMT021001UV01ControlActProcess value) {

...
/**
 * <p>PRPM_MT406110UV01.PrincipalOrganization complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="PRPM_MT406110UV01.PrincipalOrganization">
 *   &lt;complexContent>
 ...
 *         &lt;element name="languageCommunication" type="{urn:hl7-org:v3}PRPM_MT406110UV01.LanguageCommunication" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPM_MT406110UV01.PrincipalOrganization", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPMMT406110UV01PrincipalOrganization {
    ...
    protected List<PRPMMT406110UV01LanguageCommunication> languageCommunication;
     ...
     * {@link PRPMMT406110UV01LanguageCommunication }
     * 
     * 
     */
    public List<PRPMMT406110UV01LanguageCommunication> getLanguageCommunication() {
        if (languageCommunication == null) {
            languageCommunication = new ArrayList<PRPMMT406110UV01LanguageCommunication>();
        }

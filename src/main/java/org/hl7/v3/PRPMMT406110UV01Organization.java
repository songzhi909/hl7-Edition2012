...
/**
 * <p>PRPM_MT406110UV01.Organization complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="PRPM_MT406110UV01.Organization">
 *   &lt;complexContent>
 ...
 *         &lt;element name="territorialAuthority" type="{urn:hl7-org:v3}PRPM_MT406110UV01.TerritorialAuthority" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPM_MT406110UV01.Organization", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "name",
...
public class PRPMMT406110UV01Organization {
    ...
    protected List<PRPMMT406110UV01TerritorialAuthority> territorialAuthority;
     ...
     * {@link PRPMMT406110UV01TerritorialAuthority }
     * 
     * 
     */
    public List<PRPMMT406110UV01TerritorialAuthority> getTerritorialAuthority() {
        if (territorialAuthority == null) {
            territorialAuthority = new ArrayList<PRPMMT406110UV01TerritorialAuthority>();
        }

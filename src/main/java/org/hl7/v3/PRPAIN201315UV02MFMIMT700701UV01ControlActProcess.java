...
/**
 * <p>PRPA_IN201315UV02.MFMI_MT700701UV01.ControlActProcess complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="PRPA_IN201315UV02.MFMI_MT700701UV01.ControlActProcess">
 *   &lt;complexContent>
 ...
 *         &lt;element name="subject" type="{urn:hl7-org:v3}PRPA_IN201315UV02.MFMI_MT700701UV01.Subject1" maxOccurs="unbounded"/>
...
@XmlType(name = "PRPA_IN201315UV02.MFMI_MT700701UV01.ControlActProcess", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPAIN201315UV02MFMIMT700701UV01ControlActProcess {
    ...
    protected List<PRPAIN201315UV02MFMIMT700701UV01Subject1> subject;
    @XmlElement(nillable = true)
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAIN201315UV02MFMIMT700701UV01Subject1 }
     * 
     * 
     */
    public List<PRPAIN201315UV02MFMIMT700701UV01Subject1> getSubject() {
        if (subject == null) {
            subject = new ArrayList<PRPAIN201315UV02MFMIMT700701UV01Subject1>();
        }
        return this.subject;
    }

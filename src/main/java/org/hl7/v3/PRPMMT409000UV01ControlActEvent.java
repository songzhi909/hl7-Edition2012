...
/**
 * <p>PRPM_MT409000UV01.ControlActEvent complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="PRPM_MT409000UV01.ControlActEvent">
 *   &lt;complexContent>
 ...
 *         &lt;element name="dataEnterer" type="{urn:hl7-org:v3}PRPM_MT409000UV01.DataEnterer" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="custodian" type="{urn:hl7-org:v3}PRPM_MT409000UV01.Custodian" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPM_MT409000UV01.ControlActEvent", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPMMT409000UV01ControlActEvent {
    ...
    protected List<PRPMMT409000UV01DataEnterer> dataEnterer;
    @XmlElement(nillable = true)
    protected List<PRPMMT409000UV01Custodian> custodian;
     ...
     * {@link PRPMMT409000UV01DataEnterer }
     * 
     * 
     */
    public List<PRPMMT409000UV01DataEnterer> getDataEnterer() {
        if (dataEnterer == null) {
            dataEnterer = new ArrayList<PRPMMT409000UV01DataEnterer>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPMMT409000UV01Custodian }
     * 
     * 
     */
    public List<PRPMMT409000UV01Custodian> getCustodian() {
        if (custodian == null) {
            custodian = new ArrayList<PRPMMT409000UV01Custodian>();
        }

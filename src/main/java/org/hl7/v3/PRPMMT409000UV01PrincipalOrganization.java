...
/**
 * <p>PRPM_MT409000UV01.PrincipalOrganization complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="PRPM_MT409000UV01.PrincipalOrganization">
 *   &lt;complexContent>
 ...
 *         &lt;element name="languageCommunication" type="{urn:hl7-org:v3}PRPM_MT409000UV01.LanguageCommunication" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPM_MT409000UV01.PrincipalOrganization", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPMMT409000UV01PrincipalOrganization {
    ...
    protected List<PRPMMT409000UV01LanguageCommunication> languageCommunication;
     ...
     * {@link PRPMMT409000UV01LanguageCommunication }
     * 
     * 
     */
    public List<PRPMMT409000UV01LanguageCommunication> getLanguageCommunication() {
        if (languageCommunication == null) {
            languageCommunication = new ArrayList<PRPMMT409000UV01LanguageCommunication>();
        }
